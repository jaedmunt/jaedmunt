...
**Building search engines, AI pipelines, and things that go fast**
...
<img src="https://skillicons.dev/icons?i=nextjs,tailwind,figma" height="36" />
...
<img src="https://img.shields.io/badge/Weaviate-4CAF50?style=flat-square" height="22" />
<img src="https://img.shields.io/badge/FAISS-blue?style=flat-square" height="22" />
...
- **Semantic search & retrieval** — hybrid pipelines, re-ranking, freshness, HNSW graphs
- **Fast backend architecture** — making pipelines go brrr
- **Systems programming** — Go and Rust for things that need to be fast and correct
- **Econometrics** — DiD, network analysis, measurement in tech
- **Finance** — venture, macro, equities
